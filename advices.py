ADVICES = {
    ...
    'high_temp': [
        ...
        'Avoid coffee and sugary drinks, as they can increase dehydration.',
        'It is better not to go outside from 12:00 to 15:00.',
        'When outside, try to spend more time in the shade.',
        'If you feel dizzy or weak, find a cool place immediately!'
    ],
    'moderate_temp': [
        'T-shirt, shorts and... don\'t forget your hat!',
        'Excellent temperature for walking and sports.',
        'Lightweight clothing made of cotton or linen is comfortable during the daytime.',
        'Even at such temperatures, with a clear sky, you can get sunburned.'
    ],
    'low_temp': [
        'Dress in layers to easily regulate heat throughout the day.',
        'In cool weather it is easy to “dry out” your skin and lips – use hygienic lipstick and moisturizer.',
    ...
    'special': [
        'Taking regular sunset walks can reduce levels of cortisol (the stress hormone).',
        'Walking at sunset is a natural way to reset your biological clock and improve the quality of your sleep.',
        'Sunset light, through visual receptors, affects the production of dopamine in the retina and hypothalamus, which helps improve mood and reduce depressive symptoms.',
        'Sunset light does not contain the bright blue spectrum that can tire your eyes. That is why sunset walks are especially useful for those who work at screens – it is a natural “break” for the eyes.',
        'Sunset light affects the activity of the right hemisphere of the brain (responsible for creativity and imaginative thinking).'
    ],
    'remind': [
        'When sunbathing, you can get burns in just 20 minutes under high UV!',
